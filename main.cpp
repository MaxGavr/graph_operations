...
Graph graphInversion(Graph A)
{
    ...
    for (int i = 0; i < A.size(); i++) ///обход по всем элементам первого графика
    {
...
Graph graphComposition(Graph A, Graph B)
{
    ...
    for (int i = 0; i < A.size(); i ++) ///обход по всем элементам первого графика
    {
        for (int j = 0; j < B.size(); j++) ///обход по всем элементам второго графика
        {
    ...
    while(true) ///бесконечный цикл вывода меню
        {
            ...
            switch (choice) ///Выполнение операции в зависимости от выбора пользователя
                ...
                case 6: ///если была выбрана инверсия графика A
                {
                    ...
                    cout << "-----------------------------------------------------------------" << endl;
                    if (inversion.empty()) ///если график пуст
                        cout << "Инверсия графика пуста!";
                    else ///если не пуст
                        cout << "Инверсия графика A: ";
                    for (pair<int,int> s : inversion) ///для каждого элемента из инверсии
                        {
                            cout << "<" << s.first << "," << s.second << "> "; ///выводим его значение
                        }
                    cout << endl;
                ...
                case 8: ///если была выбрана композиция графиков A и B
                {
                    ...
                    cout << "-----------------------------------------------------------------" << endl;
                    if (composition.empty()) ///если композиция пуста
                        cout << "Композиция графиков A и B пуста!";
                    else ///если не пуста
                        cout << "Композиция графиков A и B: ";
                    for (pair<int,int> s : composition) ///для каждого элемента из композиции
                        {
                            cout << "<" << s.first << "," << s.second << "> "; ///выводим его значение
                        }
                    cout << endl;
                ...
                case 9: ///если была выбрана композиция графиков B и А
                {
                    ...
                    cout << "-----------------------------------------------------------------" << endl;
                    if (composition.empty()) ///если композиция пуста
                        cout << "Композиция графиков B и A пуста!";
                    else ///если не пуста
                        cout << "Композиция графиков B и А: ";
                    for (pair<int,int> s : composition) ///для каждого элемента из композиции
                        {
                            cout << "<" << s.first << "," << s.second << "> "; ///выводим его значение
                        }
